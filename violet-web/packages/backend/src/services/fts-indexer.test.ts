...
test('language index upgrade preserves results, existing tables and indexes, and covers counts', () => {
  ...
  try {
    db.exec(`CREATE TABLE HitomiColumnModel (Id INTEGER PRIMARY KEY, Language TEXT, ExistOnHitomi INTEGER, Published);
      ...
      INSERT INTO HitomiColumnModel VALUES
        (1,'korean',1,'2025-01-01'),
        (2,'korean',0,'2025-01-02'),
        (3,'english',1,'2025-01-03'),
        (4,NULL,1,'2025-01-04'),
        (5,'korean',1,'2025-01-05');`);
